...
func GenerateChain(config *params.ChainConfig, parent *types.Block, engine consensus.Engine, db ethdb.Database, shyftdb ethdb.SDatabase, n int, gen func(int, *BlockGen)) ([]*types.Block, []types.Receipts) {
	...
	genblock := func(i int, parent *types.Block, statedb *state.StateDB) (*types.Block, types.Receipts) {
		...
		blockchain, _ := NewBlockChain(db, shyftdb, nil, config, engine, vm.Config{}, nil)
...
// @shyft node UNSURE ABOUT THE CONSEQUENCES
//<<<<<<< HEAD
...
//	blockchain, _ := NewBlockChain(db, shyftdb, nil, params.AllEthashProtocolChanges, engine, vm.Config{})
