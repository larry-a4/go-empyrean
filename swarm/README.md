...
[![Travis](https://travis-ci.org/ShyftNetwork/go-empyrean.svg?branch=master)](https://travis-ci.org/ShyftNetwork/go-empyrean)
...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/ShyftNetwork/go-empyrean

    go install github.com/ShyftNetwork/go-empyrean/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/ShyftNetwork/go-empyrean`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/ShyftNetwork/go-empyrean
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/ShyftNetwork/go-empyrean/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/ShyftNetwork/go-empyrean/wiki/Code-Review-Guidelines).
